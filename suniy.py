...
opts = {
    ...
    "cmds": {
        ...
        "radio": ('muzikani qo`y', 'radioni yoq', 'radiyoni qo`sh','muzika','musiqa','music'),
        "stupid1": ('latifa aytib ber', 'meni kuldir', 'Latifa aytishni bilasanmi'),
        "open": ('oyinni och','battleni och','oyinga kir'),
        "sayt": ('saytni och','yutub','youtube','zerikdim'),
    }
}
...
def execute_cmd(cmd):
    if cmd == 'ctime':
        ...
        speak("this time is" + str(now.hour) + ":" + str(now.minute))

    elif cmd == 'radio':
        # Radioni yoqish
        os.system("C:\\Users\\Professional\\Downloads\\INSTASAMKA - ЗА ДЕНЬГИ ДА Lyrics - Текст песни - Не завожу подруг, но за деньги - да.m4a'")

    elif cmd == 'stupid1':
        # Yemagan xazil
        speak("Bitta gugurt boshini qashlagan ekan yonib ketibdi hahaahahahah")
    
    elif cmd == 'open':
        speak("C:\\Users\\Public\\Desktop\\Battlefield 4(x32).lnk")
        ...
        print("sorry i didn't listen you !")
